...
// Costanti per le classi CSS condivise
...
const INSET_PADDING_CLASS = 'pl-8';

const ICON_SIZE_CLASSES = '[&>svg]:size-4 [&>svg]:shrink-0';
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(BASE_ITEM_CLASSES, 'py-1.5 pl-8 pr-2', className)}
    checked={checked}
    {...props}
  >
    <span className={INDICATOR_CONTAINER_CLASSES}>
